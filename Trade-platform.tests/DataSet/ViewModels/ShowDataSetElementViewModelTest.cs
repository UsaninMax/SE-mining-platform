...
{
    [TestFixture]
    public class ShowDataSetElementViewModelTest
    {
        ...
        public void TestAddSelectedInstruments()
        {
            ...
            DataSetItem item = new DataSetItem.Builder()
                ...
                .Build();
            ShowDataSetElementViewModel model = new ShowDataSetElementViewModel();
            eventAggregator.GetEvent<ShowDataSetEvent>().Publish(item);
            ...
            Assert.That(model.UniqueId, Is.EqualTo(item.Id));
